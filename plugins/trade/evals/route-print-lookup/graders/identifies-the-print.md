...
PASS if the reply, in Chinese, identifies that print by all four of: its time (about 14:07 ET, or 18:07 UTC), its size (about 1.85M shares or about $450M), that it printed inside the NBBO, and that it was a qualified contingent trade (its price tied to another leg). The reply must also say that lit volume did not follow it.
